...
import { getNews } from './services/newsService' // searchNews import removed from here, only needed in SearchPage
...
function App() {
 const [articles, setArticles] = useState([])
  ...
  // 🎯 NEW: handleSearch navigates to the server-side search route
